...
.tab-btn.active { background: var(--green-100); border-color: var(--green); color: var(--green); font-weight: var(--weight-medium); }
...
.field-select:focus { outline: none; border-color: var(--green); box-shadow: var(--shadow-focus); }
...
.autocomplete-item {
  ...
  padding: var(--space-3) var(--space-4); cursor: pointer; font-size: var(--text-base); color: var(--text-primary);
}
...
.hint { font-size: var(--text-base); color: var(--text-muted); text-align: center; padding: var(--space-8) 0; }
