...
.tab-btn.active {
  ...
  color: var(--green); font-weight: var(--weight-medium);
}
...
.limit-hint { font-size: var(--text-2xs); color: var(--orange); }
...
.crop-search:focus { outline: none; border-color: var(--green); box-shadow: var(--shadow-focus); }
